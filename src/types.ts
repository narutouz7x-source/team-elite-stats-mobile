...
export type PlayerStat = { kills: number; played: number; points: number };
export type Clip = { id: string; title: string; url: string; platform: string; thumbnailUrl?: string | null; creatorName?: string; submittedBy?: string; featured?: boolean; createdAt: number; };
export type Creator = { id: string; name: string; handle?: string; bio?: string; imageUrl?: string; youtube?: string; instagram?: string; discord?: string; featured?: boolean; createdAt: number; };
